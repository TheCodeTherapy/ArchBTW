...
install_yay_packages() {
  local packages=(
    visual-studio-code-bin brave-bin google-chrome hid-fanatecff-dkms
    oversteer
  )
...
install_base_packages() {
  local packages=(
    ...
    zsh zsh-completions zsh-syntax-highlighting zsh-autosuggestions ghostty
    fd pkgconf openal ttf-hack python python-pip ipython libtool mesa glu
    ...
    obs-studio ardour wofi wl-clipboard fastfetch vlc vlc-plugin-ffmpeg
  )
